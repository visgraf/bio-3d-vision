...
few hundred lines in a single file, written in under a week, running end to end
from a synthetic scene to a four-panel figure in one command. It closed the
