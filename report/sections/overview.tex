...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}llp{0.50\textwidth}@{}}
    ...
    \textbf{exp004} & Does the rendered scene match the fixture?
      & Away from discontinuities marginally --- a knife edge that changes sign
        under a scanpath control; at them no, and the fixture is the worse of
        the two \\
    ...
    \textbf{exp009} & What does the epipolar violation cost?
      & More than rectifying does, at 9.5\texttimes{} the matcher time ---
        which still leaves the loop render-bound \\
