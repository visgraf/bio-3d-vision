...
question \emph{how well} by 65:1 on median error, on a stimulus with effectively
no occlusion --- a ratio that narrows on the tail and falls as occlusion rises.
Closing the loop helped, and its benefit was coverage over accuracy by at least
33\texttimes{} at every occlusion level. Two objectives that never once agreed on a pixel produced
