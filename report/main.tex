...
once selected the same pixel produced indistinguishable results. Knowing
\emph{where} measurement is possible outweighed knowing \emph{how uncertain} it
is by 65:1 on median error. Foveal weighting on a uniformly sampled sensor was
strictly lossy. Verging to acquire made estimation worse, through a mechanism
...
benefit was coverage over accuracy by at least 34\texttimes{}. The system's
